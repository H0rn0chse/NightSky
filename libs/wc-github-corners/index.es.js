...
let GitHubCorners = class extends s {
  constructor() {
    super(...arguments);
    this.blank = false;
    this.color = "#fff";
    this.fill = "#151513";
    this.repo = "YunYouJun/wc-github-corners";
    this.url = "";
    this.label = "View source on GitHub";
    this.reverse = false;
    this.position = "right";
  }
...
__decorateClass([
  e({ type: Boolean })
], GitHubCorners.prototype, "blank", 2);
__decorateClass([
  e({ type: String })
], GitHubCorners.prototype, "color", 2);
__decorateClass([
  e({ type: String })
], GitHubCorners.prototype, "fill", 2);
__decorateClass([
  e({ type: String })
], GitHubCorners.prototype, "repo", 2);
__decorateClass([
  e({ type: String })
], GitHubCorners.prototype, "url", 2);
__decorateClass([
  e({ type: String })
], GitHubCorners.prototype, "label", 2);
__decorateClass([
  e({ type: Boolean })
], GitHubCorners.prototype, "reverse", 2);
__decorateClass([
  e({ type: String })
], GitHubCorners.prototype, "position", 2);
GitHubCorners = __decorateClass([
  n("github-corners")
], GitHubCorners);
